...
if("TRUE" STREQUAL "TRUE")
  set(path_finder_SOURCE_PREFIX /home/nvidia/AV/src/navigation/path_finder_ros)
  set(path_finder_DEVEL_PREFIX /home/nvidia/AV/devel/.private/path_finder)
  ...
  set(path_finder_INSTALL_PREFIX /home/nvidia/AV/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'path_finder' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/AV/src/navigation/path_finder_ros/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nvidia/AV/devel/.private/path_finder/lib;/home/nvidia/AV/devel/lib;/opt/ros/kinetic/lib)
